  ...
  return (
    <AppShell>
      <header style={{ padding: '20px 32px', borderBottom: '1px solid var(--pc-border)' }}>
        <h1 style={{ margin: 0, fontSize: 22, fontWeight: 800, letterSpacing: '-.02em' }}>Help & support</h1>
        <p style={{ margin: '3px 0 0', fontSize: 13.5, color: 'var(--pc-text-muted)' }}>Report an issue and we'll get back to you by email.</p>
      </header>

      <div style={{ flex: 1, padding: '28px 32px', maxWidth: 480 }}>
        <Card padding={24}>
